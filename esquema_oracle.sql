...
CREATE TABLE Horario (
    ...
    CONSTRAINT chk_horario_dia CHECK (dia_semana IN ('LUNES', 'MARTES', 'MIÉRCOLES', 'JUEVES', 'VIERNES', 'SÁBADO')),
    CONSTRAINT chk_horario_horas CHECK (hora_fin > hora_inicio)
);
COMMENT ON TABLE Horario IS 'Bloques de horario para las clases.';
